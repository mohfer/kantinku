<div class="mx-auto">
    <header class="bg-gray-200 rounded-b-3xl p-6 -m-6 mb-6">
        <h1 class="text-2xl font-bold text-center text-gray-800">Warung Pak Didi</h1>
        <div class="flex items-center justify-center text-gray-600 text-sm mt-3 space-x-1">
        ...
        <div class="flex items-center justify-center text-gray-600 text-sm mt-1 space-x-1">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-4 h-4">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <main class="py-4 space-y-4 pb-32 ">
        <section class="flex items-center bg-white rounded-xl py-4 space-x-4">
            ...
            <div class="flex items-center rounded-lg overflow-hidden shadow-sm">
                ...
                <span class="bg-white text-black px-4 py-1 font-bold text-lg h-8 flex items-center">0</span>
                <button class="bg-primary text-black p-2 flex items-center justify-center h-8 w-8 font-bold">+</button>
            </div>
        </section>
        <section class="flex items-center bg-white rounded-xl py-4 space-x-4">
    ...
    <div class="fixed bottom-0 left-0 right-0 max-w-sm mx-auto mb-16">
        <a href="{{ route('detail-product') }}" wire:navigate class="block">
            <div class="bg-gray-200 rounded-lg py-4 m-4 flex items-center justify-center space-x-3 shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <span class="font-semibold text-gray-800">Keranjang : 0 Hidangan</span>
            </div>
        </a>
    </div>
</div>
