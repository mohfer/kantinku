<div class="bg-white min-h-screen">
    <div class="relative overflow-y-auto">
        ...
        <h3 class="text-black text-lg md:text-2xl font-semibold mt-2">Waktunya Makan!</h3> --}}
        ...
        <div class="flex justify-start gap-8 md:gap-12 mt-5 text-black text-sm md:text-base font-medium">
            <div
                class="flex flex-col items-center cursor-pointer hover:opacity-80 transition-opacity bg-gray-200 p-4 rounded-lg">
        ...
        <div class="mt-7 mb-20">
            <h3 class="text-black text-lg md:text-2xl font-semibold mb-4">Makanan Populer Hari ini</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div
                    class="flex items-center cursor-pointer hover:bg-gray-50 md:p-4 transition-colors  bg-gray-200 p-4 rounded-lg">
                    <img src="{{ asset('storage/images/Nasi Goreng Spesial.png') }}" alt="Nasi Goreng Spesial"
                        class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full object-cover shadow-sm shrink-0">
                    <p class="text-black text-base md:text-lg font-medium ml-4">Nasi Goreng Spesial</p>
                </div>
                <div
                    class="flex items-center cursor-pointer hover:bg-gray-50 md:p-4 transition-colors  bg-gray-200 p-4 rounded-lg">
                    <img src="{{ asset('storage/images/Soto Ayam.png') }}" alt="Soto Ayam"
                        class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full object-cover shadow-sm shrink-0">
                    <p class="text-black text-base md:text-lg font-medium ml-4">Soto Ayam</p>
                </div>
            </div>
        </div>
    </div>
