<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 md:hidden z-50">
    <nav class="flex justify-around items-center h-16">
        ...
        <a href="/warung" wire:navigate
            class="flex flex-col items-center justify-center flex-1 py-2 {{ request()->is('warung*') ? 'text-blue-600' : 'text-gray-600' }} hover:text-blue-600 transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/pesanan" wire:navigate
            class="flex flex-col items-center justify-center flex-1 py-2 {{ request()->is('pesanan*') ? 'text-blue-600' : 'text-gray-600' }} hover:text-blue-600 transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
